...
6. CRF 18 control: pick a master in `input\\`, encode **1080p + 360p at CRF 18** (Lanczos downscale), then Lanczos-upscale each to 4K at CRF 12. Writes `Nom-360p-24fps-crf18.mp4` and `Nom-360p-24fps-crf18-lanczos-4k.mp4` (same for 1080p). Compare the `*-lanczos-4k.mp4` files in VSR-Eval against a Lanczos upscale of the production CRF 24 360p. No 30 fps variant.
7. Quit
